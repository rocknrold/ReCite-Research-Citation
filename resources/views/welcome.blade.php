...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            body {
                font-family: 'Nunito';      
                background-image: url('{{ asset('images/crw-logo.png')}}');
    ...
    <body>
      <nav style="background-color:transparent">
          <div class="nav-wrapper">
            ...
            <ul class="right hide-on-med-and-down">
              <li><a class="waves-effect waves-teal btn black">Library<i class="material-icons right">local_library</i></a></li>
              <li><a class="waves-effect waves-teal btn black">Words<i class="material-icons right">text_format</i></a></li>
              <li><a class="waves-effect waves-teal btn black">Groups<i class="material-icons right">list</i></a></li>
      ...
      <div class="container">
        <div class="center-search">
          ...
          <blockquote>
          Find by words and add to your document list..
          </blockquote>
          <nav style="background-color:black">
          <form class="nav-wrapper" action="{{ route('try.search') }}" method="POST">
            @csrf
